...
class NewPage extends Page
{
	...
	public function PageLoad()
	{
		...
		if ($helpType == 'about')
		{
			header('Location: http://localhost:8080/SEP/Sep1/Web/NewSpaper/admin/index.php');
		}
		else if ($helpType == 'admin')
		{
			header('Location: http://localhost:8080/SEP/Sep1/Web/NewSpaper/admin/index.php?admin');
			//header('Location: http://localhost:8080/SEP/Sep1/NewSpaper/admin/index.php');
		}
		else
		{
			header('Location: http://localhost:8080/SEP/Sep1/Web/NewSpaper/index.php');
		}
	}
}
