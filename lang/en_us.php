...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['AllResources'] = 'Tất cả phòng họp';
		...
		$strings['AllResourcesOn'] = 'Tất cả phòng';
		...
		$strings['BlackoutCreated'] = 'Đã tạo thành công';
		$strings['BlackoutNotCreated'] = ' không tạo được';
		$strings['BlackoutUpdated'] = 'Cập nhật thành công';
		$strings['BlackoutNotUpdated'] = 'không thể cập nhật';
		$strings['BlackoutConflicts'] = 'Khóa phòng này đã được tạo trước đó';
		...
		$strings['ReservedResources'] = 'Đặt phòng đã đặt';
		$strings['ReservedAccessories'] = 'Phụ kiện đã dùng';
		$strings['ResourceUsageTimeBooked'] = 'Thời gian đặt phòng';	
		$strings['ResourceUsageReservationCount'] = 'Số lượng đặt phòng';
		$strings['Top20UsersTimeBooked'] = 'Top 20 người dùng - Thời gian đặt phòng';
		$strings['Top20UsersReservationCount'] = 'Top 20 người dùng - Số lượng đặt phòng';
